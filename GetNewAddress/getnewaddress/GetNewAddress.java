...
public class GetNewAddress
{
    ...
    public static void main(final String[] args) {
        String s = null;
        final String transactionID = args[0];
        try {
            final Process p = Runtime.getRuntime().exec("C:\\Program Files\\Bitcoin\\daemon\\bitcoin-cli.exe getnewaddress " + transactionID + " legacy");
            log("C:\\Program Files\\Bitcoin\\daemon\\bitcoin-cli.exe getnewaddress " + transactionID + " legacy");
